...
echo "-----------------------"
echo "Grabbing the rasbian version of NetworkTables"
echo "-----------------------"

wget http://first.wpi.edu/FRC/roborio/maven/release/edu/wpi/first/wpilib/networktables/java/NetworkTables/3.1.7/NetworkTables-3.1.7-arm-raspbian.jar -P ~/Desktop/
...
jar xf NetworkTables-3.1.7-arm-raspbian.jar
...
cp NetworkTables-3.1.7-arm-raspbian.jar ~/Desktop/vision/jar/

rm -rf Linux
rm -rf NetworkTables-3.1.7-arm-raspbian.jar
